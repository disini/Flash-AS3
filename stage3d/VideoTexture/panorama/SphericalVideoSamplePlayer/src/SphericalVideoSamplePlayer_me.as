package
{
	...
	public class SphericalVideoSamplePlayer_me extends Sprite
	{
...
//		private static const FILE_NAME:String = "file:///M:/%E6%B8%B8%E6%88%8F/CG/%E5%90%84%E5%A4%A7%E6%B8%B8%E6%88%8F%E5%8E%82%E5%95%86%E4%BD%9C%E5%93%81CG/%E9%BE%99%E4%B9%8B%E4%BA%89%E9%9C%B82.mov";
		...
		private static const VERSION:String = "20170825A";
...
//		private static const 
		...
		private var mainVideo:SphericalVideo;
		private var adVideo:SphericalVideo;
...
//		public var 
		...
		public function SphericalVideoSamplePlayer_me()
		{
...
//			initAdVideo();
		...
		{
			mainVideo = new SphericalVideo(stage, 0, 0, 960, 540);
...
//			mainVideo.autoPlay = false;
			...
			mainVideo.volume = 1;
//			mainVideo.addEventListener(SphericalVideo.AVAILABLE, onSphericalVideoAvailable);
...
//			mainVideo.addEventListener(SimpleVideoEvent.GOT_METADATA, onGotMainVideoMetaInfo);
		...
		{
			adVideo = new SphericalVideo(stage, 0, 0, 700, 400);
...
//			adVideo.addEventListener(SphericalVideo.AVAILABLE, onSphericalVideoAvailable);
...
//			adVideo.addEventListener(SimpleVideoEvent.VIDEO_RESUMED, onVideoResumed);
		...
		{
//			controlBar = new PlayControlBar(mainVideo, this, true, stage.stageWidth);
			controlBar = new PlayControlBar(mainVideo, this, mainVideo.autoPlay, stage.stageWidth);
...
//		public function onMetaData(info:Object):void
		public function onGotMainVideoMetaDataInfo(info:Object):void
		{
