package com.adobe.media
{
	...
	public class SphericalVideo3 extends EventDispatcher
	{
...
//			"tex oc, v0, fs0 <2d>\n";
			"tex oc, v0, fs0 <2d, linear, clamp, nomip>\n";// 对纹理进行线性插值，减少放大失真（马赛克）
...
//		public function SphericalVideo0(target:IEventDispatcher=null)
		public function SphericalVideo3(stage:Stage, x:int, y:int, width:int, height:int):void
		{
//			super(target);
			_stage = stage;
//			stageWidth = width;
...
//			stage3D.requestContext3DMatchingProfiles(
		...
		public function setBufferSize(width:Number, height:Number):void
		{
			_bufferWidth = width;
...
//			context3D.configureBackBuffer(_stage.stageWidth, _stage.stageHeight, 16, true, true, true);
//			context3D.configureBackBuffer(_bufferWidth, _bufferHeight, 16, true, true, true);
			context3D.configureBackBuffer(1920, 1080, 16, true, true, true);
